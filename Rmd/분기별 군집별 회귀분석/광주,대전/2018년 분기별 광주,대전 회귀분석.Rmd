...
analysis_2018_quarter1 <- analysis_2018_quarter1 %>% filter(시도 %in% c("광주","대전")) 
...
analysis_2018_quarter2 <- analysis_2018_quarter2 %>% filter(시도 %in% c("광주","대전")) 
...
analysis_2018_quarter3 <- analysis_2018_quarter3 %>% filter(시도 %in% c("광주","대전"))
...
analysis_2018_quarter4 <- analysis_2018_quarter4 %>% filter(시도 %in% c("광주","대전")) 
...
```{r}
fit <- lm(formula = 발병률 ~ NO2 + CO + SO2 + `평균 풍속(m/s)` + `평균기온(°C)`, data = analysis_2018_quarter2)
...
```{r}
fit<- lm(formula = 발병률 ~ NO2 + `평균 풍속(m/s)` + PM25, data =analysis_2018_quarter4)
