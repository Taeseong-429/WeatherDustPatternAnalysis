...
analysis_2017_quarter1 <- analysis_2017_quarter1 %>% filter(시도 %in% c("광주","대전")) 
...
analysis_2017_quarter2 <- analysis_2017_quarter2 %>% filter(시도 %in% c("광주","대전")) 
...
analysis_2017_quarter3 <- analysis_2017_quarter3 %>% filter(시도 %in% c("광주","대전"))
...
analysis_2017_quarter4 <- analysis_2017_quarter4 %>% filter(시도 %in% c("광주","대전")) 
...
```{r}
fit <- lm(formula = 발병률 ~ `평균 풍속(m/s)` + `일강수량(mm)` + CO + 
    NO2 + PM25, data = analysis_2017_quarter2)
...
```{r}
fit<- lm(formula = 발병률 ~ NO2 + `평균 풍속(m/s)` + CO, data =analysis_2017_quarter4)
