...
analysis_2017_quarter1 <- analysis_2017_quarter1 %>% filter(시도 %in% c("충북")) 
...
analysis_2017_quarter2 <- analysis_2017_quarter2 %>% filter(시도 %in% c("충북")) 
...
analysis_2017_quarter3 <- analysis_2017_quarter3 %>% filter(시도 %in% c("충북"))
...
analysis_2017_quarter4 <- analysis_2017_quarter4 %>% filter(시도 %in% c("충북")) 
...
```{r}
fit <-  lm(formula = 발병률 ~ NO2 + PM25 + PM10 + `평균 풍속(m/s)`,  data = analysis_2017_quarter1)
...
```{r}
fit<- lm(formula = 발병률 ~ NO2 + CO + `평균 현지기압(hPa)` + `평균 풍속(m/s)`, data =analysis_2017_quarter4)
