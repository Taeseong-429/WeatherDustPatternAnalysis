...
analysis_2018_quarter1 <- analysis_2018_quarter1 %>% filter(시도 %in% c("제주")) 
...
analysis_2018_quarter2 <- analysis_2018_quarter2 %>% filter(시도 %in% c("제주")) 
...
analysis_2018_quarter3 <- analysis_2018_quarter3 %>% filter(시도 %in% c("제주"))
...
analysis_2018_quarter4 <- analysis_2018_quarter4 %>% filter(시도 %in% c("제주")) 
...
```{r}
fit <-  lm(formula = 발병률 ~ O3 + PM25, data = analysis_2018_quarter1)
...
```{r}
fit <- lm(formula = 발병률 ~ NO2 + SO2 + CO, data = analysis_2018_quarter2)
...
```{r}
fit<- lm(formula = 발병률 ~ `평균기온(°C)` + NO2 + SO2 + CO, data =analysis_2018_quarter4)
