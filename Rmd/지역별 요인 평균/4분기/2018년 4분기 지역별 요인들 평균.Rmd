...
analysis_sido <- analysis_total %>% filter(substr(일시,1,7)=='2018-09'|substr(일시,1,7)=='2018-10'|substr(일시,1,7)=='2018-11') %>% group_by(시도코드,시도) %>% summarise(`평균기온(°C)` = mean(`평균기온(°C)`,na.rm=TRUE),
